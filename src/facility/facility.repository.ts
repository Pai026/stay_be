...
export class FacilityRepository extends Repository<Facility> {
  ...
  async createFacility(
    ...
    if (starCategory === 'null') facility.starCategory = null;
    else facility.starCategory = starCategory;
    facility.latitude = latitude;
    facility.longitude = longitude;
    facility.contact = contact;
    facility.policy = policy;
    if (facilities === 'null') facility.facilities = null;
    else facility.facilities = facilities;
    facility.ownerID = id;
